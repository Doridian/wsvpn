...
func (s *Server) listen() {
	...
	tlsConfigTemp := s.TLSConfig
	if tlsConfigTemp != nil && tlsConfigTemp.GetConfigForClient != nil {
		tlsConfigTemp, _ = tlsConfigTemp.GetConfigForClient(nil)
	}
